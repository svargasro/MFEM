...
void E_exact(const Vector &, Vector &); //Extra: Se define campo solución.
void f_exact(const Vector &, Vector &); //Extra: Término no homogéneo.
...
int main(int argc, char *argv[])
{
   ...
   /*
   Nombre completo: Nédélec Finite Element Collection
   Uso principal: Problemas de electromagnetismo y otros problemas de campo vectorial.
   H1 es campo escalar.
    */
